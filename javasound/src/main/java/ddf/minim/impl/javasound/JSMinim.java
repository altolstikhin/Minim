        ...
        implements MinimServiceProvider
{
    ...
    /*
     * (non-Javadoc)
     * @see ddf.minim.spi.MinimServiceProvider#start()
     */
    @Override
    public void start()
    {
    ...
    /*
     * (non-Javadoc)
     * @see ddf.minim.spi.MinimServiceProvider#stop()
     */
    @Override
    public void stop()
    {
    ...
    /*
     * (non-Javadoc)
     * @see ddf.minim.spi.MinimServiceProvider#debugOn()
     */
    @Override
    public void debugOn()
    {
    ...
    /*
     * (non-Javadoc)
     * @see ddf.minim.spi.MinimServiceProvider#debugOff()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see ddf.minim.spi.MinimServiceProvider#getSampleRecorder(ddf.minim.mixer.Recordable, java.lang.String, boolean)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see ddf.minim.spi.MinimServiceProvider#getAudioRecordingStream(java.lang.String, int, boolean)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see ddf.minim.spi.MinimServiceProvider#getAudioInput(int, int, float, int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see ddf.minim.spi.MinimServiceProvider#getAudioSample(java.lang.String, int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see ddf.minim.spi.MinimServiceProvider#getAudioSample(float[], javax.sound.sampled.AudioFormat, int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see ddf.minim.spi.MinimServiceProvider#getAudioSample(float[], float[], javax.sound.sampled.AudioFormat, int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see ddf.minim.spi.MinimServiceProvider#getAudioOutput(int, int, float, int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see ddf.minim.spi.MinimServiceProvider#getAudioRecording(java.lang.String)
     */
    @Deprecated
    @Override
