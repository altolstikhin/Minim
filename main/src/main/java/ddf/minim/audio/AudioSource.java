...
import ddf.minim.Channels;
import ddf.minim.mixer.Effectable;
import ddf.minim.mixer.Recordable;
import ddf.minim.mixer.impl.Controller;
import ddf.minim.mixer.impl.EffectsChain;
import ddf.minim.mixer.impl.SignalSplitter;
import ddf.minim.mixer.impl.StereoBuffer;
        ...
        implements Effectable, Recordable
{
    ...
    public AudioSource(AudioOut istream)
    {
        ...
        buffer = new StereoBuffer(Channels.channels(stream),
    ...
    public void close()
    {
        ...
        if (parent != null)
        {
            // parent.removeSource(this); // FIXME how does parent goet set?
        }
    }
