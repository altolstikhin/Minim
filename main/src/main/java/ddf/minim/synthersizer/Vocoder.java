...
/**
 * Vocoder is a AbstractSynthersizer that performs very basic <a href="http://en.wikipedia.org/wiki/Vocoder">vocoding</a>.
 ...
 *
 */
public class Vocoder extends AbstractSynthersizer
{
	/**
