...
/**
 * A AbstractSynthersizer which simply returns the reciprocal value of it's input. 
 * Because this AbstractSynthersizer is intended for use with control signals, 
 * rather than audio signals, it behaves as a mono AbstractSynthersizer, regardless 
...
public class Reciprocal extends AbstractSynthersizer
{
	/**
	...
	public Reciprocal(float fixedDenominator)
	{
		...
		// for this AbstractSynthersizer, denominator is the main input and can be audio
