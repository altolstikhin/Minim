...
/**
 * A AbstractSynthersizer that can generate White, Pink, or Red/Brown noise.
 * 
 ...
 * @related Noise.Tint
 */
public class Noise extends AbstractSynthersizer 
{
	/**
	 * An enumeration used to specify the tint of a Noise AbstractSynthersizer.
	 * 
	...
	/**
	 * Patch to this to control the amplitude of the noise with another AbstractSynthersizer.
	 * 
	 * @related Noise
	 */
