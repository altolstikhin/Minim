...
/**
 * Sampler is the AbstractSynthersizer version of AudioSample and is
        ...
        extends AbstractSynthersizer
{
     ...
     */
    public Sampler(String filename, int maxVoices, MinimServiceProvider system)
    {
