...
/**
 * A AbstractSynthersizer which provides <a href="http://en.wikipedia.org/wiki/Waveshaper">waveshaping distortion</a>. 
 ...
 */
public class WaveShaper extends AbstractSynthersizer
{
	/**
