 ...
 * This class is generally used by an <code>Oscil</code> AbstractSynthersizer, but
...
public class Frequency
{
    ...
    public static Frequency ofPitch(String pitchName)
    {
        ...
        {
            LOG.debug(pitchName + " matches the pitchRegex.");
            float noteOctave;
            ...
            LOG.debug("midiNote based on octave = " + midiNote);
            ...
            LOG.debug("midiNote based on naturalness = " + midiNote);
            ...
            if (matcher.find())
            {
                ...
                float noteOffset = noteNameOffsets.get(noteNameString);
                midiNote += noteOffset;
            }
            LOG.debug("midiNote based on noteName = " + midiNote);
        ...
        {
            LOG.debug(pitchName + " DOES NOT MATCH.");
