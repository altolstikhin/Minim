...
/**
 * <p>
 * An Oscil is a AbstractSynthersizer that generates audio by oscillating over a Waveform 
 ...
 * </p>
 * <p>
 * Another abstraction the Oscil AbstractSynthersizer makes use of is the Frequency class. 
...
public class Oscil extends AbstractSynthersizer
{
	...
	/**
	 * Patch to this to control the phase of the oscillator with another AbstractSynthersizer.
	 * 
	...
	/**
	 * Patch to this to control the DC offset of the Oscil with another AbstractSynthersizer. 
	...
	// constructors
	/**
	 * Constructs an Oscil AbstractSynthersizer, given frequency in Hz, amplitude, and a waveform
	 * 
	...
	/**
	 * Constructs an Oscil AbstractSynthersizer given frequency in Hz and amplitude. This
	...
	/**
	 * Constructs an Oscil AbstractSynthersizer given a Frequency and amplitude. This oscillator
	 * uses a sine wave.
	 * 
	 * @param frequency
	...
	/**
	 * Constructs an Oscil AbstractSynthersizer given a Frequency, amplitude, and a waveform
	 * 
	 * @param frequency
	 *            Frequency: the frequency this Oscil should oscillate at.
	 * @param amplitude
