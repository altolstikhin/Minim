...
/**
 * A AbstractSynthersizer that starts at a value and changes linearly to another value over a specified time.
 * 
        ...
        extends AbstractSynthersizer
{
    ...
    public Line(float dT, float beginningAmplitude, float endAmplitude)
    {
        ...
        lineNow = 0f;
        isActivated = false;
        LOG.debug(" dampTime = " + lineTime + " begAmp = " + begAmp + " now = " + lineNow);
    }
    ...
    protected void uGenerate(float[] channels)
    {
        ...
        else
        {
            ...
            // Minim.debug(" dampTime = " + dampTime + " begAmp = " + begAmp + " amp = " + amp + " dampNow = " +
            // dampNow);
