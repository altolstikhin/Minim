 ...
 * visualization purposes, in which case you can use a Sink AbstractSynthersizer to tick the EnvelopeFollower
 ...
 * 
 */
public class EnvelopeFollower extends AbstractSynthersizer
{ 
	/**
