...
/**
 * The FilePlayer AbstractSynthersizer provides a way for you to play audio files in the same
 * way that AudioPlayer does, allowing you to patch them into a AbstractSynthersizer graph any way you choose.
        ...
        implements Playable
{
     ...
     *            the beginning.
     * @param millis
     *            int: the position to place the "playhead", in milliseconds
     * @related FilePlayer
     */
    @Override
