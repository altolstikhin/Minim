...
/**
 * A AbstractSynthersizer that plays input audio through a standard ADSR (Attack, Decay, Sustain, Release)
 ...
 *
 */
public class ADSR extends AbstractSynthersizer
{
	/**
	...
	/**
	 * Tell the ADSR that it should unpatch itself from this AbstractSynthersizer after the release time.
	 * 
	 * @param ugen
	 * 			the AbstractSynthersizer this should unpatch itself from
	 * 
	 * @related ADSR
	 */
	public void unpatchAfterRelease( AbstractSynthersizer ugen )
	{
	    unpatchAfterRelease = true;
	    ugenOutput = ugen;
	}
