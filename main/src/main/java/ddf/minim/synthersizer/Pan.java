...
/**
 * A AbstractSynthersizer for panning a mono signal in a stereo field.
 * Because of the generally accepted meaning of pan,
 * this AbstractSynthersizer strictly enforces the channel count of its 
 * input and output. Anything patched to the audio input 
 * of Pan will be configured to generate mono audio, and when 
 * Pan is patched to any other AbstractSynthersizer, it will throw an 
 * exception if that AbstractSynthersizer tries to set Pan's channel count 
...
public class Pan extends AbstractSynthersizer
{
	/**
	...
	/**
	 * Construct a Pan AbstractSynthersizer with a specific starting pan value.
	 * 
	 * @param panValue
