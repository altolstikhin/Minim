...
/**
 * A AbstractSynthersizer that generates a simple envelope that changes from a starting value to a
 ...
 */
public class Damp
        extends AbstractSynthersizer
{
    private static final Logger LOG = LoggerFactory.getLogger(DFT.class);
    /**
     * The default input is "audio." You don't need to patch directly to this input,
     * patching to the AbstractSynthersizer itself will accomplish the same thing.
     * 
     * @related Damp
    ...
    private AbstractSynthersizer ugenOutput;
    ...
    public Damp(float attackTime, float dampTime, float maxAmp, float befAmp, float aftAmp)
    {
        ...
        isActivated = false;
        amp = beforeAmplitude;
        LOG.debug(" attackTime = " + attackTime + " dampTime = " + dampTime
    ...
    /**
     * The AbstractSynthersizer this Damp should unpatch itself from after the release time.
     * 
     * @param output
     *            the AbstractSynthersizer that this Damp should unpatch to after the Damp completes
     * @related Damp
     */
    public void unpatchAfterDamp(AbstractSynthersizer output)
    {
        unpatchAfterDamp = true;
        ugenOutput = output;
    }
