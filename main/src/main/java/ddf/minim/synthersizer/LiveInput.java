...
/**
 * LiveInput is a way to wrap an input stream with the AbstractSynthersizer interface so that you can 
 * easily route incoming audio through a AbstractSynthersizer graph. You can get an AudioStream that is 
...
public class LiveInput extends AbstractSynthersizer 
{
