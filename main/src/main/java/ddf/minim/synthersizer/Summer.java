 ...
 * down the chain. Unlike most AbstractSynthersizer effects, you can patch more than one AbstractSynthersizer to
 * a Summer.
 * 
        ...
        implements AudioSignal
{
    ...
    private ArrayList<AbstractSynthersizer> m_ugens;
    ...
    public Summer()
    {
        m_ugens = new ArrayList<AbstractSynthersizer>();
    }
    ...
    {
        LOG.debug("Bus::removeInput - Removing " + input + " to the m_ugens list of " + this);
        synchronized (m_ugens)
        {
    ...
    protected void sampleRateChanged()
    {
        ...
        synchronized (m_ugens)
        {
            for (int i = 0; i < m_ugens.size(); i++)
            {
                AbstractSynthersizer u = m_ugens.get(i);
                if (u != null)
                {
    ...
    // Doing this means not having to rewrite all of the AbstractSynthersizer list handling
    ...
    /**
     * Generates a buffer of samples by ticking this AbstractSynthersizer mono.length times.
