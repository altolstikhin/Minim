...
/**
 * The AbstractSynthersizer class is an abstract class which provides the basis for all
 * UGens in Minim. AbstractSynthersizer is short for Unit Generator, which is simply something
 * that either generates a sample value, or transforms the sample value produced by
 * another AbstractSynthersizer. Since everything is a AbstractSynthersizer, there is a common interface for
 ...
 * </pre>
 * 
 * This says that a Line AbstractSynthersizer should control the value of the Oscil's frequency.
 ...
 */
public abstract class AbstractSynthersizer
{
    private static final Logger LOG = LoggerFactory.getLogger(AbstractSynthersizer.class);
     ...
     * to the channel count of the AbstractSynthersizer that owns it, whereas a CONTROL
    ...
    // ddf: AbstractSynthersizer class members are before the UGenInput definition because the
    // UGenInput class
    // refers to some of these. I think it's clearer to see these before reading
    // the
    // UGenInput code.

    // list of UGenInputs connected to this AbstractSynthersizer
    private ArrayList<UGenInput> m_allInputs;

    // last values generated by this AbstractSynthersizer
    private float[] m_lastValues;
    // m_sampleRate of this AbstractSynthersizer
    private float m_sampleRate;
    // number of outputs connected to this AbstractSynthersizer
    private int m_nOutputs;
    // counter for the m_currentTick with respect to the number of Outputs
    private int m_currentTick;

    /**
     * A UGenInput represents parameter of the AbstractSynthersizer that can be
     ...
     * as the owning AbstractSynthersizer, in other words the length of the array
    ...
    {
        private AbstractSynthersizer m_incoming;
         ...
         *            the InputType of this UGenInput
         * @param value
         *            the initial float value used for all last values
         */
         ...
         * This will be called by the owning AbstractSynthersizer if this input
         * is an AUDIO input.
         * 
        ...
        public void setChannelCount(int numberOfChannels)
        {
            ...
            // make sure our incoming AbstractSynthersizer knows about this
            if (m_incoming != null)
            {
        ...
        /**
         * The outer AbstractSynthersizer is the AbstractSynthersizer that owns this input.
         * For instance, calling this on the frequency UGenInput
         * member of an Oscil will return the Oscil.
         * 
         * @return the AbstractSynthersizer that owns this UGenInput
         */
        public AbstractSynthersizer getOuterUGen()
        {
            return AbstractSynthersizer.this;
        }


        /**
         * The incoming AbstractSynthersizer is the AbstractSynthersizer that is patched to
         * this UGenInput. When this input is ticked, it
         * will tick the incoming AbstractSynthersizer and store the result
         * in its last values.
         * 
         * @return the AbstractSynthersizer that is patched to this UGenInput
         */
        public AbstractSynthersizer getIncomingUGen()
        {
            return m_incoming;
        }
        ...
        /**
         * This method is called when a AbstractSynthersizer is patched to this input.
         * Typically you will not call this method directly,
         * use AbstractSynthersizer's patch method instead.
         * 
         * @param in
         *            the AbstractSynthersizer being patched to this input
         */
        public void setIncomingUGen(AbstractSynthersizer in)
        {
            m_incoming = in;
            if (m_incoming != null)
            {
        ...
        /**
         * Returns true if a AbstractSynthersizer is patched to this UGenInput.
         * 
         * @return true if a AbstractSynthersizer is patched to this UGenInput
         */
        ...
        // this will be called by the owning AbstractSynthersizer *only* when something is
        ...
        {
            LOG.debug("UGenInput: " + " signal = " + getInputTypeAsString() + " " + (m_incoming != null));
        }
    } // ends the UGenInput inner class


    /**
     * Constructor for a AbstractSynthersizer.
     */
    protected AbstractSynthersizer()
    {
    ...
    /**
     * Send the output of this AbstractSynthersizer to another AbstractSynthersizer, UGenInput, or AudioOutput.
     ...
     * 
     * @shortdesc Send the output of this AbstractSynthersizer to another AbstractSynthersizer, UGenInput, or AudioOutput.
     * @example Basics/PatchingAnInput
     * @param connectToUGen
     *            The AbstractSynthersizer to patch to.
     * @return When patching to a AbstractSynthersizer or UGenInput, the AbstractSynthersizer being patched to is returned
    ...
    public final AbstractSynthersizer patch(AbstractSynthersizer connectToUGen)
    {
        setSampleRate(connectToUGen.m_sampleRate);
        // jam3: connecting to a AbstractSynthersizer is the same as connecting to it's first
        // input
        connectToUGen.addInput(this);
        // TODO jam3: m_nOutputs should only increase when this chain will be
        // ticked!
        m_nOutputs += 1;
        LOG.debug("m_nOutputs = " + m_nOutputs);
        return connectToUGen;
    }


    /**
     * Connect the output of this AbstractSynthersizer to a specific UGenInput of a AbstractSynthersizer.
     * 
     * @param connectToInput
     *            The UGenInput to patch to.
     * @return the AbstractSynthersizer that owns connectToInput
     */
    public final AbstractSynthersizer patch(UGenInput connectToInput)
    {
    ...
    /**
     * Patch the output of this AbstractSynthersizer to the provided AudioOuput. Doing so will
     * immediately result in this AbstractSynthersizer and all UGens patched into it to begin
     * generating audio.
     * 
     * @param audioOutput
     *            The AudioOutput you want to connect this AbstractSynthersizer to.
     */
    public final void patch(AudioOutput audioOutput)
    {
        LOG.debug("Patching " + this + " to the output " + audioOutput + ".");
     ...
     * AbstractSynthersizer is patched to, you can override this method in your derived class.
     ...
     * 
     * @param input
     *            the AbstractSynthersizer to add as an input
     */
    ...
    protected void addInput(AbstractSynthersizer input)
    {
        ...
        LOG.debug("AbstractSynthersizer addInput called.");
        // TODO change input checking to an Exception?
        if (m_allInputs.size() > 0)
        {
            LOG.debug("Initializing default input on something");
            this.m_allInputs.get(0).setIncomingUGen(input);
        }
        else
        {
            System.err.println("Trying to connect to AbstractSynthersizer with no default input.");
        }
    }


    /**
     * Unpatch this AbstractSynthersizer from an AudioOutput or other AbstractSynthersizer.
     * This causes this AbstractSynthersizer and all UGens patched into it to stop generating audio
     * if they are not patched to an AudioOuput somewhere else in the chain.
     * 
     * @shortdesc Unpatch this AbstractSynthersizer from an AudioOutput or other AbstractSynthersizer.
     * @param audioOutput
     *            The AudioOutput this AbstractSynthersizer should be disconnected from.
     */
    public final void unpatch(AudioOutput audioOutput)
    {
        LOG.debug("Unpatching " + this + " from the output " + audioOutput + ".");
        unpatch(audioOutput.bus);
    }


    /**
     * Remove this AbstractSynthersizer as an input of fromUGen.
     * 
     * @param fromUGen
     *            The AbstractSynthersizer to unpatch from.
     */
    public final void unpatch(AbstractSynthersizer fromUGen)
    {
    ...
    /**
     * When a AbstractSynthersizer is unpatched from this AbstractSynthersizer, removeInput is called.
     * If you've written an AbstractSynthersizer subclass that needs to know when this
     ...
     * 
     * @param input
     *            the AbstractSynthersizer to remove as an input to this AbstractSynthersizer
     */
    // This currently does nothing, but is overridden in Summer.
    protected void removeInput(AbstractSynthersizer input)
    {
        LOG.debug("AbstractSynthersizer removeInput called.");
    ...
    /**
     * Generates one sample frame for this AbstractSynthersizer.
     * 
     * @param channels
     *            An array that represents one sample frame. To generate a mono
     *            signal, pass an array of length 1, if stereo an array of
     *            length 2, and so on. How a AbstractSynthersizer deals with multi-channel sound
    ...
    public final void tick(float[] channels)
    {
        ...
        if (0 == m_currentTick)
        {
            ...
            // and then uGenerate for this AbstractSynthersizer
            uGenerate(channels);
    ...
    /**
     * Implement this method when you extend AbstractSynthersizer. It will be called when your
     * AbstractSynthersizer needs to generate one sample frame of audio. It is expected that you
     * will assign values to the array and <em>not</em> simply modify the
     * existing values. In the case where you write a AbstractSynthersizer that takes audio
    ...
    /**
     * Return the last values generated by this AbstractSynthersizer. This will most often be
     * used by sub-classes when pulling data from their inputs.
     * 
     * @return float[]: array containing the most recent sample frame this AbstractSynthersizer generated
     */
    ...
    /**
     * Returns the sample rate of this AbstractSynthersizer.
     * 
     * @return float: the current sample rate of this AbstractSynthersizer
     */
     ...
     * the sample rate of your AbstractSynthersizer has changed. You might need to do this to
    ...
    /**
     * Set the sample rate for this AbstractSynthersizer.
     * 
     * @param newSampleRate
     *            float, the sample rate this AbstractSynthersizer should generate at.
     */
    ...
    // set the sample rate of any AbstractSynthersizer they create whenever they want. In fact,
    ...
    public final void setSampleRate(float newSampleRate)
    {
        if (m_sampleRate != newSampleRate)
        {
            ...
            // these are guaranteed to have an incoming AbstractSynthersizer
            // if one doesn't it's probably a bug!
            for (int i = 0; i < m_allInputs.size(); ++i)
            {
                AbstractSynthersizer inputIncoming = m_allInputs.get(i).getIncomingUGen();
    ...
    /**
     * Let this AbstractSynthersizer know how many channels of audio you will be asking it for.
     * This will be called automatically when a AbstractSynthersizer is patched to an AudioOuput
     * and propagated to all UGenInputs of type AUDIO.
     * 
     * @shortdesc Let this AbstractSynthersizer know how many channels of audio you will be asking it for.
     * @param numberOfChannels
     *            how many channels of audio you will be generating with this AbstractSynthersizer
     */
    public void setChannelCount(int numberOfChannels)
    {
        for (int i = 0; i < m_allInputs.size(); ++i)
    ...
    /**
     * Returns the number of channels this AbstractSynthersizer has been configured to generate.
     * 
     * @return int: how many channels of audio this AbstractSynthersizer will generate
     */
    public int channelCount()
    {
        return m_lastValues.length;
     ...
     * of this AbstractSynthersizer actually changing. Override this function in
     * sub-classes of AbstractSynthersizer if you need to reconfigure things
    ...
    /**
     * Prints all inputs connected to this AbstractSynthersizer (for debugging)
     */
    public void printInputs()
    {
        for (int i = 0; i < m_allInputs.size(); i++)
        {
            LOG.debug("m_allInputs " + i + " ");
